...
urlpatterns = [
    ...
    path('', include('portfolio.backend.news.urls')),
    path('about/', include('portfolio.backend.about.urls')),
    ...
    path('users/', include('portfolio.backend.users.urls', namespace='users')),
