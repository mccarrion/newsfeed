...
from ..logic.crud_user import get_current_active_user, get_current_user_new
from ..schema import article as schemas
from ..schema import user as user_schema
from ..logic import crud_article, crud_favorite
...
def favorite_article(article_id: int,
    ...
    user = get_current_user_new(access_token, db)
